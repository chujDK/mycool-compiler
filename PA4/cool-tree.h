...
// extends for semant check
#define EXTRAS_for_SEMANT

#ifdef EXTRAS_for_SEMANT

	#define METHOD_SEMANT 0
	#define ATTR_SEMANT 1

	#define ASSIGN_SEMANT 3
	#define STATIC_DISPATCH_SEMANT 4
	#define DISPATCH_SEMANT 5
	#define COND_SEMANT 6
	#define LOOP_SEMANT 7
	#define TYPECASE_SEMANT 8
	#define BLOCK_SEMANT 9
	#define LET_SEMANT 10
	#define PLUS_SEMANT 11
	#define SUB_SEMANT 12
	#define MUL_SEMANT 13
	#define DIVIDE_SEMANT 14
	#define NEG_SEMANT 15
	#define LT_SEMANT 16
	#define EQ_SEMANT 17
	#define LEQ_SEMANT 18
	#define COMP_SEMANT 19
	#define INT_CONST_SEMANT 20
	#define BOOL_CONST_SEMANT 21
	#define STRING_CONST_SEMANT 22
	#define NEW__SEMANT 23
	#define ISVOID_SEMANT 24
	#define NO_EXPR_SEMANT 25
	#define OBJECT_SEMANT 26
...
#ifdef EXTRAS_for_SEMANT
	virtual Symbol get_first_symbol() { return NULL; }
	virtual Symbol get_second_symbol() { return NULL; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	virtual int get_expr_type() = 0;
	virtual Expression get_first_expr() { return NULL; } // first expr
	virtual Expression get_second_expr() { return NULL; } // second expr
	virtual Expression get_third_expr() { return NULL; } // third expr
	virtual Expressions get_expr_list() { return NULL; } // all expr in list
	virtual Symbol get_first_symbol() { return NULL; }
	virtual Symbol get_second_symbol() { return NULL; }
...
#ifdef EXTRAS_for_SEMANT
	virtual Expression get_first_expr() { return NULL; };
	virtual Symbol get_first_symbol() { return NULL; };
	virtual Symbol get_second_symbol() { return NULL; };
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_feature_type() { return METHOD_SEMANT;}
	Symbol get_return_type() { return return_type; }
	Symbol get_name() { return name; }

	Expression get_first_expr() { return expr; }
	Symbol get_first_symbol() { return name; }
	Symbol get_second_symbol() { return return_type; }
...
#ifdef EXTRAS_for_SEMANT
	int get_feature_type() { return ATTR_SEMANT; }
	Symbol get_name() { return name; }

	Expression get_first_expr() { return init; }
	Symbol get_first_symbol() { return name; }
	Symbol get_second_symbol() { return type_decl; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return ASSIGN_SEMANT; };
	Expression get_first_expr() { return expr; };
	Symbol get_first_symbol() { return name; };
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return STATIC_DISPATCH_SEMANT; }
	Expression get_first_expr() { return expr; } // first expr
	Expressions get_expr_list() { return actual; } // all expr in list
	Symbol get_first_symbol() { return type_name; } // only used by new maybe
	Symbol get_second_symbol() { return name; } // only used by new maybe
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return DISPATCH_SEMANT; };
	Expression get_first_expr() { return expr; }
	Expressions get_expr_list() { return actual; }
	Symbol get_first_symbol() { return name; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return COND_SEMANT; };
	Expression get_first_expr() { return pred; }
	Expression get_second_expr() { return then_exp; }
	Expression get_third_expr() { return else_exp; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return LOOP_SEMANT; }
	Expression get_first_expr() { return pred; }
	Expression get_second_expr() { return body; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return TYPECASE_SEMANT; }
	Expression get_first_expr() { return expr; }
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return BLOCK_SEMANT; };
	Expressions get_expr_list() { return body; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return LET_SEMANT; };
	Expression get_first_expr() { return init; }
	Expression get_second_expr() { return body; }
	Symbol get_first_symbol() { return identifier; }
	Symbol get_second_symbol() { return type_decl; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return PLUS_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return SUB_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return MUL_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return DIVIDE_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return NEG_SEMANT; };
	Expression get_first_expr() { return e1; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return LT_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return EQ_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return LEQ_SEMANT; };
	Expression get_first_expr() { return e1; }
	Expression get_second_expr() { return e2; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return COMP_SEMANT; };
	Expression get_first_expr() { return e1; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return INT_CONST_SEMANT; };
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return BOOL_CONST_SEMANT; };
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return STRING_CONST_SEMANT; };
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return NEW__SEMANT; };
	Symbol get_first_symbol() { return type_name; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return ISVOID_SEMANT; };
	Expression get_first_expr() { return e1; };
#endif
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return NO_EXPR_SEMANT; }
#endif
};
...
#ifdef EXTRAS_for_SEMANT
	int get_expr_type() { return OBJECT_SEMANT; }
	Symbol get_first_symbol() { return name; }
#endif
};
